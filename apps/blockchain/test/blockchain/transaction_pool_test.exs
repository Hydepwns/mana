defmodule Blockchain.TransactionPoolTest do
  ...
  defp create_mock_raw_transaction(opts \\ []) do
    ...
    gas_price = Keyword.get(opts, :gas_price, 20_000_000_000)  # 20 Gwei
