defmodule Blockchain.Transaction.Blob do
  ...
  """
  @spec validate_blob_data_consistency(t(), list({binary(), binary(), binary()})) :: :ok | {:error, term()}
  def validate_blob_data_consistency(%__MODULE__{blob_versioned_hashes: versioned_hashes}, blob_data_list) do
