defmodule ExWire.Layer2.Optimistic.OptimisticRollup do
  ...
  def init(opts) do
    ...
    state = %__MODULE__{
      ...
      challenge_period: opts[:challenge_period] || 7 * 24 * 60 * 60,  # 7 days
    ...
    Process.send_after(self(), :check_challenge_expiry, 60_000)  # Every minute
