defmodule ExWire.Sync.SnapshotGeneratorTest do
  ...
  setup do
    ...
    opts = [
      ...
      max_chunk_size: 1024,  # Small chunks for testing
  ...
  describe "Snapshot Generation" do
    ...
    test "generates snapshot with compression", %{generator: generator} do
      ...
      assert {:ok, :generating} = SnapshotGenerator.generate_snapshot(block_number, compression: true)
    ...
    test "maintains good compression ratios", %{generator: generator} do
      ...
      receive do
        {:snapshot_generated, {:ok, result}} ->
          ...
          assert result.compression_ratio >= 1.2, "Poor compression ratio: #{result.compression_ratio}"
