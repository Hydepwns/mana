defmodule VerkleTree.Crypto.Native do
  ...
  """
  @spec compute_root_commitment(binary(), binary(), binary()) :: {:ok, binary()} | {:error, term()}
  def compute_root_commitment(_existing_root, _key, _value), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  @spec generate_verkle_proof([binary()], [binary()], binary()) :: {:ok, binary()} | {:error, term()}
  def generate_verkle_proof(_path_commitments, _values, _root_commitment), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  @spec verify_verkle_proof(binary(), binary(), [{binary(), binary()}]) :: {:ok, boolean()} | {:error, term()}
  def verify_verkle_proof(_proof, _root_commitment, _key_value_pairs), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  @spec batch_verify([{binary(), binary(), [{binary(), binary()}]}]) :: {:ok, boolean()} | {:error, term()}
